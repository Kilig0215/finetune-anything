...
class BaseExtendSam(nn.Module):
    ...
    def __init__(self, ckpt_path=None, fix_img_en=False, fix_prompt_en=False, fix_mask_de=False, model_type='vit_b', adapt = False):
        ...
        self.ori_sam = sam_model_registry[model_type](ckpt_path, adapt)
...
class SemanticSam(BaseExtendSam):
    ...
    def __init__(self, ckpt_path=None, fix_img_en=False, fix_prompt_en=False, fix_mask_de=False, class_num=20, model_type='vit_b', adapt=False):
        super().__init__(ckpt_path=ckpt_path, fix_img_en=fix_img_en, fix_prompt_en=fix_prompt_en,
                         fix_mask_de=fix_mask_de, model_type=model_type, adapt=adapt)
